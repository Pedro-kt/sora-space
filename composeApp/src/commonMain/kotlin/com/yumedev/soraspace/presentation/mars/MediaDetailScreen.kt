...
fun MediaDetailScreen(
    ...
    Box(modifier = Modifier.fillMaxSize().background(SoraColors.Background)) {

        // Imagen de fondo (thumbnail mientras carga el asset)
        AsyncImage(
            model              = when (val s = uiState) {
        ...
        if (uiState is MediaDetailUiState.Loading) {
        ...
        // Contenido scrollable desde abajo
        Column(
            modifier = Modifier
                .fillMaxWidth()
